...
test_annot_base = '/project_data/ramanan/achakrav/misc/3D/project/multiperson/mmdetection/data/mupots-3d/'
...
for ts in range(20):
    ...
    for i in range(num_frames):
        ...
        pred_p3d = util.load_pred.get_pred(sum(sequencewise_frames[:-1]) + i)

        matches = util.matcher.match(gt_p3d, pred_p3d, o1, safe_traversal_order[1:], 150)
